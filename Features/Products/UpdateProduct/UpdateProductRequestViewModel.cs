...
public record UpdateProductRequestViewModel(string ID, string Name, string Description, string CategoryId, List<string> Tags,
    ...
    bool IsActive, bool IsActivePoint, Grade Grade);
public class UpdateProductRequestValidator : AbstractValidator<UpdateProductRequestViewModel>
{
...
public class UpdateProductEndPointRequestProfile : Profile
{
    public UpdateProductEndPointRequestProfile()
    {
        CreateMap<UpdateProductRequestViewModel, UpdateProductOrchestrator>();
        CreateMap<UpdateProductOrchestrator, UpdateProductCommand>();
