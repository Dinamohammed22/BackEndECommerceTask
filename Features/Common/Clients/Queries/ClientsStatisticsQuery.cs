...
{
    public record ClientsStatisticsQuery(DateTime From, DateTime To) : IRequestBase<ClientsStatisticsDTO>;

    public class ClientsStatisticsQueryHandler : RequestHandlerBase<Client, ClientsStatisticsQuery, ClientsStatisticsDTO>
    {
        public ClientsStatisticsQueryHandler(RequestHandlerBaseParameters<Client> requestParameters) : base(requestParameters)
        {
        }

        public async override Task<RequestResult<ClientsStatisticsDTO>> Handle(ClientsStatisticsQuery request, CancellationToken cancellationToken)
        {
