...
{
    public class GetCompanyRequestByIDResponseViewModel
    {
    ...
    public class GetCompanyRequestByIDResponseProfile : Profile
    {
        public GetCompanyRequestByIDResponseProfile()
        {
            CreateMap<GetCompanyRequestByIdDTO, GetCompanyRequestByIDResponseViewModel>();
        }
    }
}
