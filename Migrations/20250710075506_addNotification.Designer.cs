...
namespace KOG.ECommerce.Migrations
{
    ...
    [Migration("20250710075506_addNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.Advertisements.Advertisement", b =>
                {
                    ...
                    b.ToTable("Advertisement", "Advertisements");
                });

            modelBuilder.Entity("KOG.ECommerce.Models.BlackListTokens.BlackListToken", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("BlackListToken", "BlackListTokens");
                });
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.CompanyGovernorates.CompanyGovernorate", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("CompanyGovernorate", "CompanyGovernorates");
                });

            modelBuilder.Entity("KOG.ECommerce.Models.Coupons.Coupon", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.Notifications.NotificationMessage", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("NotificationMessage", "NotificationMessages");
                });

            modelBuilder.Entity("KOG.ECommerce.Models.OrderItems.OrderItem", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<double>("ItemLiter")
                        .HasColumnType("float");

                    b.Property<int>("ItemPoint")
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrderItem", "OrderItems");
                });

            modelBuilder.Entity("KOG.ECommerce.Models.Orders.Order", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.Products.Product", b =>
                {
                    ...
                    b.Property<string>("SpecificationMetrix")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.Companies.Company", b =>
                {
                    ...
                    b.HasOne("KOG.ECommerce.Models.Users.User", "User")
                        .WithOne("Company")
                        .HasForeignKey("KOG.ECommerce.Models.Companies.Company", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.CompanyGovernorates.CompanyGovernorate", b =>
                {
                    b.HasOne("KOG.ECommerce.Models.Companies.Company", "Company")
                        .WithMany("CompanyGovernorates")
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.OrderItems.OrderItem", b =>
                {
                    b.HasOne("KOG.ECommerce.Models.Orders.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.Orders.Order", b =>
                {
                    ...
                    b.HasOne("KOG.ECommerce.Models.ShippingAddresses.ShippingAddress", "ShippingAddress")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("KOG.ECommerce.Models.Companies.Company", b =>
                {
                    b.Navigation("CompanyGovernorates");
